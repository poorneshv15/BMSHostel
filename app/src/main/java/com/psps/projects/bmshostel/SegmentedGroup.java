...
public class SegmentedGroup extends RadioGroup {
    ...
    public SegmentedGroup(Context context) {
        ...
        mTintColor = resources.getColor(info.hoang8f.android.segmented.R.color.radio_button_selected_color);
        mUnCheckedTintColor = resources.getColor(info.hoang8f.android.segmented.R.color.radio_button_unselected_color);
        mMarginDp = (int) getResources().getDimension(info.hoang8f.android.segmented.R.dimen.radio_button_stroke_border);
        mCornerRadius = getResources().getDimension(info.hoang8f.android.segmented.R.dimen.radio_button_conner_radius);
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray typedArray = getContext().getTheme().obtainStyledAttributes(
                attrs,
                info.hoang8f.android.segmented.R.styleable.SegmentedGroup,
                0, 0);

        try {
            mMarginDp = (int) typedArray.getDimension(
                    info.hoang8f.android.segmented.R.styleable.SegmentedGroup_sc_border_width,
                    getResources().getDimension(info.hoang8f.android.segmented.R.dimen.radio_button_stroke_border));

            mCornerRadius = typedArray.getDimension(
                    info.hoang8f.android.segmented.R.styleable.SegmentedGroup_sc_corner_radius,
            ...
            mTintColor = typedArray.getColor(
                    info.hoang8f.android.segmented.R.styleable.SegmentedGroup_sc_tint_color,
                    getResources().getColor(info.hoang8f.android.segmented.R.color.radio_button_selected_color));

            mCheckedTextColor = typedArray.getColor(
                    info.hoang8f.android.segmented.R.styleable.SegmentedGroup_sc_checked_text_color,
                    getResources().getColor(android.R.color.white));

            mUnCheckedTintColor = typedArray.getColor(
                    com.psps.projects.bmshostel.R.styleable.SegmentedGroup_sc_unchecked_tint_color,
    ...
    private class LayoutSelector {
        ...
        private int getChildren() {
            return com.psps.projects.bmshostel.SegmentedGroup.this.getChildCount();
        }

        private int getChildIndex(View view) {
            return com.psps.projects.bmshostel.SegmentedGroup.this.indexOfChild(view);
        }
